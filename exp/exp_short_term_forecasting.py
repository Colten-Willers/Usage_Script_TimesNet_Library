...
class Exp_Short_Term_Forecast(Exp_Basic):
    ...
    def train(self, setting):
        ...
        for epoch in range(self.args.train_epochs): # tqdm() Added tqdm here.
            print("At this point.") # Added text here.
            iter_count = 0
            train_loss = []

            self.model.train()
            epoch_time = time.time()
            for i, (batch_x, batch_y, batch_x_mark, batch_y_mark) in tqdm(enumerate(train_loader)): # Also added tqdm here.
                iter_count += 1
